...
# Configurations used for creating and training GAN
LATENT_DIM = 64
IM_CHANNELS = 1  # For colored mnist chage to 3
IM_PATH = r"D:\gan\data\train"
IM_EXT = 'png'
IM_SIZE = (28, 28)
BATCH_SIZE = 128
NUM_EPOCHS = 50
...
class Discriminator(nn.Module):
    r"""
    Discriminator mimicks the design for probability discriminator thinks that
